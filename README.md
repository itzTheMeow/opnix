...
-   **🐛 Issues**: [Report bugs and request features](https://github.com/itzTheMeow/opnix/issues)
-   **💬 Discussions**: [Ask questions and share configurations](https://github.com/itzTheMeow/opnix/discussions)
